...
public class ReleasesMetadata {
    ...
    public static class ReleaseSource {
        ...
        private String repo;
        private String githubReleaseFrom;
        ...
        public String getGithubReleaseFrom() {
            return githubReleaseFrom;
        }

        public void setGithubReleaseFrom(String githubReleaseFrom) {
            this.githubReleaseFrom = githubReleaseFrom;
        }
